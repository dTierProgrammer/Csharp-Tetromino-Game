...
public struct ImgBank
{
    ...
    public static readonly Texture2D GridBg = GetContent.Load<Texture2D>("Image/Board/bg_gradient");
    ...
    public static readonly Texture2D TimeTitle = GetContent.Load<Texture2D>("Image/Board/time");
}